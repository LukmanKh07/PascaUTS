package com.example.movie_0558;
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                detailActivity.putExtra("EXTRA_RATE",movie.getRate().toString());
                detailActivity.putExtra("EXTRA_ORIGINAL",movie.getOriginal().toString());
                detailActivity.putExtra("EXTRA_LANGUAGE",movie.getLanguage().toString());
